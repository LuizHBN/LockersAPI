...
public record ReadRentRequestDTO(UUID rentRequestId, ReadLockerDTO lockerDTO, UUID userId, Date rentStartDate, Date rentFinishDate, double amount, UUID openingKey) {
