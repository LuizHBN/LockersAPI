...
public record ReadRentRequestDTO(UUID rentRequestId, Locker locker, UUID userId, Date rentStartDate, Date rentFinishDate, double amount, UUID openingKey) {
    public ReadRentRequestDTO(RentRequest rentRequest) {
        this(
                rentRequest.getId(),
                rentRequest.getLocker() != null ? rentRequest.getLocker() : null,
